...
public class BodyMetaProviderTest {
  ...
  private static String inJsonSchema;
  ...
  public static void cleanup() throws IOException {
    final File generatedJavaDir = new File(AppConstants.GENERATED_RESOURCES_DIR);
    FileUtils.deleteDirectory(generatedJavaDir);
  }

  @Test
  public void getMetaModel() {
    final JsonObject metaModel = providerUT.getMetaModel(config);
    assertTrue(metaModel.toString().equals(inJsonSchema));
  }
  ...
  public void deserialize() throws IOException {
    final JsonObject json = Json.createObjectBuilder()
        ...
        .add("baz", "baf")
        .build();
    final byte[] byteArray = json.toString().getBytes();
    final JsonObject deserialized = providerUT.deserialize(byteArray);
  ...
  public static SoapBodyDescriptor getSoapBodyDescriptor() {
    ...
    final Definitions defs = parser.parse(WSDL_URL);

    final BindingOperation bindingOperation = defs.getBinding("XigniteCurrenciesSoap")
    ...
    final SoapBodyDescriptor soapBodyDescriptor = new SoapBodyDescriptor();
    soapBodyDescriptor.setBindingName("XigniteCurrenciesSoap");
    soapBodyDescriptor.setOperationName("GetCurrencyIntradayChartCustom");
